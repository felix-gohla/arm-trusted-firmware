...
{
	struct sm1_bl31_param *from_bl2;

	/* Initialize the console to provide early debug support */
	aml_console_init();

	from_bl2 = (struct sm1_bl31_param *)arg0;
 ...
 ******************************************************************************/
static const interrupt_prop_t sm1_interrupt_props[] = {
...
static const gicv2_driver_data_t sm1_gic_data = {
	.gicd_base = AML_GICD_BASE,
	.gicc_base = AML_GICC_BASE,
	.interrupt_props = sm1_interrupt_props,
	.interrupt_props_num = ARRAY_SIZE(sm1_interrupt_props)
};
...
void bl31_platform_setup(void)
{
	...
	gicv2_driver_init(&sm1_gic_data);
	gicv2_distif_init();
